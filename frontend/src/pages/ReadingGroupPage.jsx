...
const ReadingGroupPage = ({ username, isAuthenticated }) => {
  ...
  console.log("reading_group:", reading_group);
  ...
  //const isUserPending = reading_group?.user?.some(member => member.username === username && !member.in_reading_group);

  console.log("isUserMember:", isUserMember, username, reading_group?.user);
  console.log("isUserPending:", isUserPending, username);
