    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quest_scope",
                    models.CharField(
                        choices=[("personal", "Личное"), ("group", "Групповое")],
                        default="personal",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to=bookapp.models.UniqueFileNameGenerator("rewards/"),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=bookapp.models.UniqueFileNameGenerator(
                            "profile_img/"
                        ),
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=bookapp.models.UniqueFileNameGenerator("epub_files/"),
                        validators=[
                            bookapp.validators.validate_epub_file_extension,
                            bookapp.validators.validate_epub_file_size,
                            bookapp.validators.validate_file_is_not_empty,
                        ],
                    ),
                ),
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=bookapp.models.UniqueFileNameGenerator("book_img/"),
                    ),
                ),
                (
                    "visibility",
                ...
                (
                    "hashtags",
                    models.ManyToManyField(
                        blank=True, related_name="books", to="bookapp.hashtag"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "participation_type",
                    models.CharField(
                        choices=[("personal", "Персональное"), ("group", "Групповое")],
                        max_length=20,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "board_type",
                    models.CharField(
                        choices=[("group", "Группа"), ("user", "Пользователь")],
                        default="group",
                        max_length=10,
                ...
                (
                    "width",
                    models.PositiveIntegerField(
                        default=5, help_text="Количество колонок", verbose_name="Ширина"
                    ),
                ),
                (
                    "height",
                    models.PositiveIntegerField(
                        default=5, help_text="Количество строк", verbose_name="Высота"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="bookapp.UserToReadingGroupState",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["quest", "user"], name="bookapp_que_quest_i_db8f94_idx"
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["book", "reading_group"],
                        name="bookapp_boo_book_id_2e0b6a_idx",
                    ),
                    models.Index(
                        fields=["user", "reading_group"],
                        name="bookapp_boo_user_id_3597d1_idx",
                    ),
                    models.Index(
                        fields=["book", "user"], name="bookapp_boo_book_id_0ffb5b_idx"
                    ),
                    models.Index(
                        fields=["parent_comment"], name="bookapp_boo_parent__355a31_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        default=0,
                        help_text="Процент прочитанного (0-100)",
                ...
                (
                    "last_read_at",
                    models.DateTimeField(
                        auto_now=True, verbose_name="Последнее чтение"
                    ),
                ),
                (
                    "book",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "book"], name="bookapp_rea_user_id_cd0465_idx"
                    ),
                    models.Index(
                        fields=["user", "is_completed"],
                        name="bookapp_rea_user_id_03f4ac_idx",
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["board", "x", "y"],
                        name="bookapp_pri_board_i_6dc6f2_idx",
                    )
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="bookapp_use_user_id_657e96_idx",
                    )
                ],
